<?php
/**
 * @version   1.3-SNAPSHOT October 10, 2012
...
class GantryFusionLayout extends AbstractRokMenuLayout
{
    ...
    protected function renderItem(JoomlaRokMenuNode &$item, RokMenuNodeTree &$menu)
    {
	   ...
	   if ($item_params->get('fusion_menu_entry_type','normal') == 'normal'):
        ?>
        ...
        <?php else:
		   ...
		   $module_id   = $item_params->get('fusion_menu_module');
...
<div class="rt-menubar fusionmenu">
    <ul class="menutop level1 <?php echo $this->isJsEnabled; ?>" <?php if (array_key_exists('tag_id',$this->args)): ?>id="<?php echo $this->args['tag_id'];?>"<?php endif;?> style="margin-left: <?php echo $gantry->get('menu-offset'); ?>px;">
