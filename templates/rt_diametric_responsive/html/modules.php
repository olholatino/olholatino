	        ...
	        <?php endif; ?>
	            <div class="rt-block">
	            	<div class="module-surround">
						...
						<?php if (preg_match("/icon[0-4]{1,}/i", $params->get('moduleclass_sfx'))) : ?>
						<div class="module-icon"></div>
						<?php endif; ?>
							<h2 class="title"><?php echo $menu_title_item->title.' '.JText::_('Menu'); ?></h2>
						<?php if (preg_match("/title[1-2]{1,}/i", $params->get('moduleclass_sfx'))) : ?>
 	...
 	if (!empty ($module->content)) : ?>
        ...
        <?php endif; ?>
            <div class="rt-block">
				...
				<?php if (preg_match("/box[7]{1,}/i", $params->get('moduleclass_sfx'))) : ?>
